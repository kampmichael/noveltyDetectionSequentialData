...
ACTIONS_FILE = "fakenews_vocab.txt" # "timeser_vocab.txt" # "adfald_vocabulary.txt" # "yelpchi_vocab.txt" #
CLUSTERS_FILE = "kmeans_inferred_clusters.json"
TEST_FILE = "testing_fakenews.json" # "testing_timeser.json" # "testing_adfald.json" # "testing_yelpchi.json" #

EMBEDDING_DIM = 100 # fakenews # 128 # timeser2 # 128 # adfald # 256 # yelpchi #
HIDDEN_DIM = 512 # fakenews # 64 # timeser2 # 512 # adfald # 512 # yelpchi #
BATCH = 64 # 8 #
PAD_IDX = 5144 # fakenews # 1001 # timeser2 # 341 # adfald # 6024 # yelpchi #
MAX_LEN = 2000
...
with open("kmeans_per_cluster_perplexities.json","w") as outp:
...
np.save("kmeans_test_labels", test_labels)
np.save("kmeans_cluster_perplexities", cluster_perplexities)
np.save("kmeans_global_perplexities", global_perplexities)
